...
import WpLink from '~/components/functional/WpLink'
import ImageObject from '~/components/partials/ImageObject'
...
Vue.component(WpLink.name, WpLink)
Vue.component(ImageObject.name, ImageObject)